...
namespace WebStore.Data
{
        ...
        public static IEnumerable<Section> Sections { get; } = new[]
    {
        ...
        public static IEnumerable<Product> Products { get; } = new[]
        {
            ...
            new Product{Id = 6, Name = "Лёгкое голубое поло", Price = 1025, ImageUrl = "product6.jpg", Order = 5, SectionId = 2, BrandId = 2 },
            ...
            new Product{Id = 9, Name = "Красное китайское платье", Price = 1025, ImageUrl = "product9.jpg", Order = 8, SectionId = 25, BrandId = 2 },
            new Product{Id = 10, Name = "Женские джинсы", Price = 1025, ImageUrl = "product10.jpg", Order = 9, SectionId = 25, BrandId = 2 },
